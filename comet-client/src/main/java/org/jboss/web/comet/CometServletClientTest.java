...
public class CometServletClientTest extends Thread {
    ...
    public CometServletClientTest(URL url, int d_max, int delay) throws Exception {
        ...
        while (this.max < MIN_REQ_NUM) {
        this.max = generator.nextInt(d_max);
        }
         */
        this.delay = delay;
    }
    ...
    public void run() {
        try {
            ...
            System.out.println("[Thread-" + getId() + "] terminated -> " + System.currentTimeMillis());
            try {
                close();
    ...
    public void runit() throws Exception {
        ...
        // For each thread print out the maximum, minimum and average response times
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 1) {
            //System.err.println("Usage: java " + CometServletClientTest.class.getName() + " URL [n] [max] [delay]");
            System.err.println("Usage: java " + CometServletClientTest.class.getName() + " URL [n] [max] [delay]");
